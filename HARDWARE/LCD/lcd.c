...
void LCD_Display_Score(u8 score)
{
	char str[20]="score:";
	LCD_Fill(170, 165, 239, 185, WHITE);
	sprintf(&str[6], "%d", score);
	LCD_ShowString(170, 165, 100, 20, 16, (u8 *)str);	
	
}

void LCD_Display_level(u8 level)
{
	char str[20]="Level:";
	
	sprintf(&str[6], "%d", level);
	LCD_ShowString(0, 165, 50, 20, 16, (u8 *)str);
}
